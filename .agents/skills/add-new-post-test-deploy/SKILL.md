...
1. Consult the **LLM Wiki**: [`wiki/index.md`](file:///ubuntu-20.04/home/merolhack/fl/mach-playbook/wiki/index.md) for full project architecture, E-E-A-T guidelines, language specifications, and environment gotchas.
